...
public class radJuice : MonoBehaviour
{
    [Header("Components")]
    radMovement moveScript;
    radJump jumpScript;
    ...
    void Start()
    {
        moveScript = GetComponent<radMovement>();
        jumpScript = GetComponent<radJump>();
    }
    ...
    void Update()
    {
        ...
        jumpVelocity = jumpScript.body.velocity.y;// Mathf.Clamp(jumpScript.velocity.y, 0, maxSpeed);
